...
```ts
const Action = v.filterItems<TInput, TOuput>(operation);
```

## Generics

- `TInput` <Property {...properties.TInput} />
- `TOuput` <Property {...properties.TOuput} />
...
If you pass a type predicate as `operation`, the output type of the action is narrowed to an array of the predicated type.
